...
def attack(
    ...
    """Расчёт урона вызванного атакой разных классов."""
...
def defence(
    ...
    """Расчёт блокировки урона разных классов."""
    if char_class == 'warrior':
...
def special(
    ...
    """Расчёт урона специального умения разных классов."""
    if char_class == 'warrior':
        return (
...
def start_training(
    ...
    """Вывод описания выбранного класса.
    Начало тренировки команд: атака, защита, спец.умение.
    """
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Выбор класса персонажа и подтверждение класса."""
    approve_choice: str = ''
    char_class: str = ''
